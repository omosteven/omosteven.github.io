                                    ...
                                    <div class="col-lg-8 col-md-9">
                                        <div class="top-info-wrap text-right">
                                            <ul class="top-info">
                                                ...
                                                <li><a href="#">+2347037048119</a></li>
                                                <li><a href="#">foodelv@gmail.com</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-2 col-md-4 col-5">
                            <div class="logo-area" style="font-size:0.5em;font-family: sans-serif">
                                <a href="" style="width:10em"><img src="images/foodev" alt="FooDev"></a>
                                <!-- <i style="color:red">Food</i><i style="color:rgb(0,0,70)">Delv</i> -->
                            </div>
                        </div>
